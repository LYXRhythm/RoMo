...
class MeshNet(nn.Module):
    ...
    def forward(self, mesh_npz):
        centers, corners, normals, neighbor_index = self.mesh_process(mesh_npz)
    ...
    def mesh_process(self, mesh_npz):
        face = mesh_npz['faces']
        neighbor_index = mesh_npz['neighbors']
