...
def step1_setting():
    parser = argparse.ArgumentParser(description='CR23: The Robust Discriminative Learning for 2D-3D Unsupervised Cross-Modal Retrieval')
    # GPU
    ...
    parser.add_argument('--log_name', type=str, default='CR23_PLA_Stage')
    parser.add_argument('--ckpt_dir', type=str, default='CR23_PLA_Stage')
    ...
    parser.add_argument('--output_dim', type=int, default=1024, help='output shape')
    parser.add_argument('--class_num', type=int, default=10)
    parser.add_argument('--lambda1', type=float, default=0.75)
    parser.add_argument('--indomain_tau', type=float, default=0.01)
...
def step2_setting():
    ...
    # Dataset
    parser.add_argument("--data_name", type=str, default="mnist3d", help="data name")
    parser.add_argument('--log_name', type=str, default='CR23_RDL_Stage')
    parser.add_argument('--ckpt_dir', type=str, default='CR23_RDL_Stage')
    parser.add_argument('--num_workers', type=int, default=0)    
    ...
    parser.add_argument('--output_dim', type=int, default=256, help='output shape') 
    parser.add_argument('--class_num', type=int, default=10)
    parser.add_argument('--lambda_rb', type=float, default=0.7)         
    parser.add_argument('--lambda_crossmodal', type=float, default=0.3) 
    parser.add_argument('--crossmodal_tau', type=float, default=0.1)
    args = parser.parse_args()
    return args
